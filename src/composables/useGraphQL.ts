...
export type CharacterSearchQueryVariables = Exact<{
  ...
  omit?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>> | InputMaybe<Scalars['Int']['input']>>;
}>;
...
/**
 * __useCharacterSearchQuery__
 *
 * To run a query within a Vue component, call `useCharacterSearchQuery` and pass it any options that fit your needs.
 * When your component renders, `useCharacterSearchQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useCharacterSearchQuery({
 *   search: // value for 'search'
 *   pick: // value for 'pick'
 *   omit: // value for 'omit'
 * });
 */
export function useCharacterSearchQuery(variables: CharacterSearchQueryVariables | VueCompositionApi.Ref<CharacterSearchQueryVariables> | ReactiveFunction<CharacterSearchQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<CharacterSearchQuery, CharacterSearchQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<CharacterSearchQuery, CharacterSearchQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<CharacterSearchQuery, CharacterSearchQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<CharacterSearchQuery, CharacterSearchQueryVariables>(CharacterSearchDocument, variables, options);
}
export function useCharacterSearchLazyQuery(variables: CharacterSearchQueryVariables | VueCompositionApi.Ref<CharacterSearchQueryVariables> | ReactiveFunction<CharacterSearchQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<CharacterSearchQuery, CharacterSearchQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<CharacterSearchQuery, CharacterSearchQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<CharacterSearchQuery, CharacterSearchQueryVariables>> = {}) {
